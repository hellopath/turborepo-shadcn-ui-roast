...
const ActionableImageWrapper = forwardRef<HTMLDivElement, ActionableImageWrapperProps>(
  ({ className, src, alt, onDelete, ...props }, ref) => {
    return (
      <div
        ref={ref}
        ...
        {...props}
      >
        <button onClick={onDelete} className={`absolute bottom-2 transform -translate-x-1/2 left-1/2 w-6 h-6 text-white z-10 fill-gray-500`}>
          <XCircleIcon />
        </button>
